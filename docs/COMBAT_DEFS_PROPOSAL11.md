# Creature Messaging Proposal - Round 11 (Incremental)
...
### smouldering skeletal dreadsteed — `smouldering_skeletal_dreadsteed.rb`

**arrival**

- `A smouldering skeletal dreadsteed canters in, azure sparks flying from {pronoun} fiery mane.`  *(201x)*

### Ithzir adept — `ithzir_adept.rb`

**arrival**

- `An Ithzir adept staggers in, barely able to keep {pronoun} feet!`  *(3x)*

### mongrel hobgoblin — `mongrel_hobgoblin.rb`

**arrival**

- `A mongrel hobgoblin staggers in, howling ferociously!`  *(72x)*

### immense gold-bristled hinterboar — `immense_gold-bristled_hinterboar.rb`

**arrival**

- `An immense gold-bristled hinterboar staggers in, squealing hoarsely with pain.`  *(48x)*

### skeletal warhorse — `skeletal_warhorse.rb`

**death**

- `The skeletal warhorse falls to the ground dead, {pronoun} calcified bones still pulsating with a blinding white hue.`  *(2x)*

### Ithzir initiate — `ithzir_initiate.rb`

**arrival**

- `An Ithzir initiate staggers in, barely able to keep {pronoun} feet!`  *(2x)*

### triton radical — `triton_radical.rb`

**arrival**

- `A triton radical staggers in, dragging {reflexive} along with labored breaths.`  *(10x)*

### lithe veiled sentinel — `lithe_veiled_sentinel.rb`

**arrival**

- `A lithe veiled sentinel staggers in, clutching at a seeping wound.`  *(5x)*

### Ithzir seer — `ithzir_seer.rb`

**arrival**

- `An Ithzir seer staggers in, barely able to keep {pronoun} feet!`  *(4x)*

### triton magus — `triton_magus.rb`

**arrival**

- `A triton magus staggers in, dragging {reflexive} along with labored breaths.`  *(2x)*

### Ithzir scout — `ithzir_scout.rb`

**arrival**

- `An Ithzir scout staggers in, barely able to keep {pronoun} feet!`  *(2x)*
...
- `The moulis flails wildly for a moment before collapsing, {pronoun} appendages dropping lifelessly to the ground.`  *(64x)*

### sleek black kiramon stalker — `sleek_black_kiramon_stalker.rb`

**death**

- `A sleek black kiramon stalker grabs you by the head and twists violently. You hear a loud *CRACK* as your neck bones snap and your body goes limp!`  *(237x)*

### forest bendith — `forest_bendith.rb`

**death**

- `The forest bendith drops lifelessly to the ground.`  *(30x)*

### niveous giant warg — `niveous_giant_warg.rb`

**death**

- `A niveous giant warg grabs you by the head and twists violently. You hear a loud *CRACK* as your neck bones snap and your body goes limp!`  *(14x)*

### cadaverous tatterdemalion ghast — `cadaverous_tatterdemalion_ghast.rb`

**death**

- `A cadaverous tatterdemalion ghast grabs you by the head and twists violently. You hear a loud *CRACK* as your neck bones snap and your body goes limp!`  *(8x)*

### lava golem — `lava_golem.rb`

**death**

- `The lava golem falls to the floor dead, {pronoun} husk still pulsating with a blinding white hue.`  *(7x)*

### hobgoblin acolyte — `hobgoblin_acolyte.rb`

**death**

- `The hobgoblin acolyte gasps a final prayer, then falls to the ground dead.`  *(6x)*
...
### flesh golem — `flesh_golem.rb`

**death**

- `The flesh golem falls to the floor dead, {pronoun} husk still pulsating with a blinding white hue.`  *(3x)*

### eidolon — `eidolon.rb`

**death**

- `The eidolon falls to the floor dead, {pronoun} ethereal mist still pulsating with a blinding white hue.`  *(3x)*

### animated slush — `animated_slush.rb`

**death**

- `The animated slush falls to the ground dead, {pronoun} icy surface still pulsating with a blinding white hue.`  *(3x)*

### stone giant — `stone_giant.rb`

**death**

- `The stone giant falls to the floor dead, {pronoun} stone hide still pulsating with a blinding white hue.`  *(3x)*

### soul golem — `soul_golem.rb`

**death**

- `The soul golem falls to the floor dead, {pronoun} husk still pulsating with a blinding white hue.`  *(3x)*

### skeletal lord — `skeletal_lord.rb`

**death**

- `The skeletal lord falls to the floor dead, {pronoun} calcified bones still pulsating with a blinding white hue.`  *(2x)*

### skeletal soldier — `skeletal_soldier.rb`

**death**

- `The skeletal soldier falls to the ground dead, {pronoun} calcified bones still pulsating with a blinding white hue.`  *(2x)*

### glacial morph — `glacial_morph.rb`

**death**

- `The glacial morph falls to the ground dead, {pronoun} icy surface still pulsating with a blinding white hue.`  *(2x)*

### stone gargoyle — `stone_gargoyle.rb`

**death**

- `The stone gargoyle falls to the ground dead, {pronoun} stone hide still pulsating with a blinding white hue.`  *(2x)*

### ice golem — `ice_golem.rb`

**death**

- `The ice golem falls to the ground dead, {pronoun} husk still pulsating with a blinding white hue.`  *(2x)*

### ice elemental — `ice_elemental.rb`

**death**

- `The ice elemental falls to the ground dead, {pronoun} icy vapor still pulsating with a blinding white hue.`  *(2x)*
...
left to the defs review. Top 150 of 5083 templates:
...
| 2620 | 4 | `{s} loses an aura of resolve.` |
...
| 1338 | 6 | `{s} takes a deep breath, blinking a couple of times before resuming a calm expression.` |
...
| 446 | 6 | `{s} raises {p} hands high, laces them together and brings them crashing down towards you!` |
...
| 415 | 1 | `{s} clumsily twists {p} palsied hands into a spell form, {p} fingers trailing waves of psionic energ` |
...
| 386 | 1 | `{s} rears back, emitting an awful keening cry that resounds shrilly through the area!` |
...
| 372 | 1 | `{s} skitters in, raising {p} scythe-like forelegs and straightening to an impressive height.` |
...
| 339 | 1 | `{s} blends with the shadows, moving too swiftly for the eye to follow.` |
...
| 229 | 1 | `{s} shakes free from {p} stunned state, {p} monstrous features twitching painfully!` |
...
| 218 | 1 | `{s} hurries in, torment making {p} mismatched eyes bulge.` |
...
| 13367 | 121 | `{s} blinks and looks around in confusion for a moment.` |
...
| 7651 | 527 | `{s} appears dazed and unsure.` |
...
| 4701 | 120 | `{s} is awakened by your attack!` |
