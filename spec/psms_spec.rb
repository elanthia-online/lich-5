...
describe Infomon, ".setup!" do
  ...
  context "can set up data" do
    it "creates key/value pair for our testing" do
      Infomon.set("cman.acrobatsleap", 0)
      Infomon.set("cman.bearhug", 0)
      Infomon.set("cman.berserk", 0)
      Infomon.set("weapon.reactiveshot", 0)
      Infomon.set("weapon.reversestrike", 0)
      Infomon.set("weapon.spinkick", 0)
      Infomon.set("weapon.thrash", 0)
      Infomon.set("weapon.twinhammer", 1)
      Infomon.set("weapon.volley", 0)
      Infomon.set("weapon.wblade", 0)
      Infomon.set("weapon.whirlwind", 0)
      Infomon.set("armor.blessing", 0)
      Infomon.set("armor.reinforcement", 0)
      Infomon.set("armor.support", 0)
      Infomon.set("shield.tfocus", 0)
      Infomon.set("cman.krynch", 1)
      Infomon.set("cman.mongoose", 1)
      Infomon.set("cman.vaultkick", 1)
      Infomon.set("feat.martialmastery", 1)
      Infomon.set("feat.tattoo", 1)
    end
  end
end
