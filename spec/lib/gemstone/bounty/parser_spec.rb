...
RSpec.describe Lich::Gemstone::Bounty::Parser, "#parse" do
  ...
  context "unfinished tasks with specific requirements ready for us to work towards" do
    ...
    context "heirloom" do
      ...
      it "can parse a loot task near a town" do
      ...
      it "can tell we have an unfinished assist heirloom by culling task near a town" do
    ...
    context "escort" do
      ...
      it "can tell we have an unfinished escort task for female" do
    ...
    context 'herbs' do
      ...
      it 'can parse an Icemule herb task in subterranean tunnels' do
    ...
    context "dangerous" do
      ...
      it "can tell we have an unfinished assist dangerous by culling task near a town" do
    ...
    context "rescue" do
      ...
      it "can tell we have an unfinished rescue task for female" do
      ...
      it "can tell we have an unfinished rescue task in Shadow Valley" do
