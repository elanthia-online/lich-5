  ...
  describe 'real force-exit of a hung teardown (subprocess)' do
    ...
    it 'forces a hung process to exit after the deadline' do
      ...
      begin
        ...
        # Tie the pass to the actual deadline: an unrelated early crash (e.g. a
        # failed require or arm) would also exit 1 -- but almost instantly, and
        # with stdout/stderr suppressed there would be no other clue.
