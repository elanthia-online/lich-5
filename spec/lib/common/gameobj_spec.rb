...
RSpec.describe Lich::Common::GameObj do
  before do
    ...
    %i[@@staging_inv @@staging_reserve @@staging_loot @@staging_npcs
      ...
      described_class.class_variable_set(cv, nil) if described_class.class_variable_defined?(cv)
    end
    described_class.class_variable_set(:@@staging_contents, {}) if described_class.class_variable_defined?(:@@staging_contents)
