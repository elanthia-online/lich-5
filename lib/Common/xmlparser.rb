        ...
        begin
              ...
              if attributes['name'] =~ /Injury/i
                ...
                if rank == 0
                  ...
                  Thread.new {
                    ...
                    Lich::Gemstone::Game._puts "#{$cmd_prefix}health"
                  }
                end
              else
                @injuries[attributes['id']]['wound'] = 0
          ...
          if (name == 'app') and (@name = attributes['char'])
            ...
            if $frontend =~ /^(?:wizard|avalon)$/
              Lich::Gemstone::Game._puts "#{$cmd_prefix}_flag Display Dialog Boxes 0"
              sleep 0.05
              Lich::Gemstone::Game._puts "#{$cmd_prefix}_injury 2"
              sleep 0.05
            ...
            Lich::Gemstone::Game._puts("#{$cmd_prefix}_flag Display Inventory Boxes 1")
          end
        rescue
