...
module Lich
  module Common
    module Authentication
      # Reads and writes the legacy entry.dat saved-login file.
      # The GTK launcher's Lich::Common::GUI::State delegates here for the
      # same names; entry.yaml handling lives in EntryStore.
      module LegacyEntryFile
