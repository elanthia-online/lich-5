      ...
      module LoginTabUtils
        ...
        def self.apply_theme_to_ui_elements(theme_state, ui_elements, providers)
          if theme_state
            ...
            ui_elements[:account_book]&.override_background_color(:normal, Gdk::RGBA::parse("rgba(0,0,0,0)")) if ui_elements[:account_book]
            ui_elements[:notebook]&.override_background_color(:normal, Gdk::RGBA::parse("rgba(0,0,0,0)")) if ui_elements[:notebook]
          else
            # Disable dark theme
