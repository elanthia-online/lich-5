      ...
      module Definitions
        module Supplements
          ...
          class << self
            ...
            # Attacks are grouped by slot and messages by family, since
            # those decide where the rows splice and a wrong one is
            ...
            def loaded
              {
                ...
                messages: memoize(:messages).transform_values { |rows| rows.map(&:first) }
