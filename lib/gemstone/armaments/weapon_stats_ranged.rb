...
=begin Template
        :Name   => {
            ...
            :base_rt       => 5,
            :min_rt        => 4,
            :weapon_class  => :bow :crossbow :ammunition
          },
=end
        @@weapon_stats_ranged = [
          :composite_bow  => {
          ...
          :heavy_crossbow => {
            ...
            :all_names     => ["heavy crossbow", "heavy arbalest", "kut'ziko", "siege crossbow"],
            :damage_types  => [66.6, 0.0, 33.7],
