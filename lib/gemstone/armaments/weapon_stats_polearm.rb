...
=end
        @@weapon_stats_polearm = {
          :awl_pike      => {
            ...
            :damage_types  => [slash: 0.0, crush: 13.0, puncture: 87.0, special: [:none]],
          ...
          :halberd       => {
            ...
            :damage_types  => [slash: 33.3, crush: 33.3, puncture: 33.3, special: [:none]],
          ...
          :hammer_of_kai => {
            ...
            :damage_types  => [slash: 0.0, crush: nil, puncture: nil, special: [:none]], # data missing from wiki
          ...
          :jeddart_axe   => {
            ...
            :damage_types  => [slash: 50.0, crush: 50.0, puncture: 0.0, special: [:none]],
          ...
          :javelin       => {
            ...
            :damage_types  => [slash: 17.0, crush: 0.0, puncture: 83.0, special: [:none]],
          ...
          :lance         => {
            ...
            :damage_types  => [slash: 0.0, crush: 33.0, puncture: 67.0, special: [:none]],
          ...
          :trident       => {
            ...
            :damage_types  => [slash: 33.0, crush: 0.0, puncture: 67.0, special: [:none]],
