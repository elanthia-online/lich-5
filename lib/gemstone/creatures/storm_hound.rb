{
  ...
  messaging: {
    description: [
      "<pre{{log2|margin-right=26em}}>You have never seen anything quite like a storm hound, so you are not really sure what to make of it or how dangerous it might be.</pre>\n\n;Assess\n<pre{{log2|margin-right=26em}}>The vapor hound is medium in size and about three feet high in its current state.</pre>"
    ],
    arrival: [],
    flee: [],
    death: [],
