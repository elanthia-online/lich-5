  ...
  abilities: [
    {
      ...
      dispellable: nil,
      notes: "No warding roll seen. Debuffs bar id 607 seen 3x in Nerten logs 2026-08-18..21; longest first-read countdown 23s. Mechanical effect not measured here."
    }
  ],
  alchemy: [],
  abilities_misc: [],
