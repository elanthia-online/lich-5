...
module Infomon
  ...
  module Parser
    module Pattern
      ...
      Resource = /^(?<type>(?:Essence|Necrotic Energy|Lore Knowledge|Motes of Tranquility|Devotion|Nature's Grace|Grit|Luck)): (?<weekly>[0-9,]+)/50,000 \(Weekly\)\s+(?<total>[0-9,]+)/200,000 \(Total\)/
      Suffused = /^Suffused (?:Essence|Necrotic Energy|Lore Knowledge|Motes of Tranquility|Devotion|Nature's Grace|Grit|Luck): (?<suffused>[0-9,]+)$/
